    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <!-- <el-button @click="handleReplyClick(scope.row)" type="text" size="small" v-if="myUserType === '2'">回复</el-button> -->
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
export default {
  data() {
    ...
    methods: {
      handleClick (msg) {
        this.$store.commit('changeOrderId', msg)
        this.$router.push({
          name: 'orderPage',
          params: {
            id: msg.id,
